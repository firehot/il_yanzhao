...
describe GoodsErrorsController do
  ...
  describe "POST create" do
    ...
    describe "success" do
      it "能够成功保存票据信息" do
        lambda do
          post :create, :goods_error => @attr
        end.should change(GoodsError,:count).by(1)
      end

      it "redirects to the created goods_exception" do
        post :create, :goods_error => @attr
        response.should redirect_to(goods_error_path(assigns(:goods_error)))
      end
    end

    describe "with invalid params" do
      it "re-renders the 'new' template" do
        post :create, :goods_error => {}
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      ...
      it "redirects to the goods_exception" do
        put :update, :id => @goods_error,:goods_error => @attr
        response.should redirect_to(goods_error_path(@goods_error))
      end
    end
