...
describe "goods_cat_promotions/new" do
  before(:each) do
    assign(:goods_cat_promotion, stub_model(GoodsCatPromotion,
      :goods_cat => nil,
      :from_fee => "",
      :from_fee => "",
      :to_fee => "",
  ...
  it "renders new goods_cat_promotion form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => goods_cat_promotions_path, :method => "post" do
