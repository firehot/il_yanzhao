...
set :unicorn_env, "cx_production"
set :app_env,     "production"

set :application, "cx_il_yanzhao_rails32"
set :repository,  "."
...
#
set :scm, :git
server "cx.yanzhaowuliu.com",:app,:web,:db,:primary => true

set :user,"lmis"
set :use_sudo,false
default_run_options[:pty]=true

set :deploy_to,"~/app/cx_il_yanzhao_rails32"
...
task :update_database_yml do
  replacements = {
    'il_yanzhao_r32_production' => 'il_yanzhao_cx_production'
  }
