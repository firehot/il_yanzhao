...
IlYanzhao::Application.configure do
  ...
  config.assets.precompile += %w( il_javascripts.js il_ie_javascripts.js il_ie6_javascripts.js il_login_javascripts.js il_stylesheets.css  il_login.css il_ie_stylesheets.css )
end
