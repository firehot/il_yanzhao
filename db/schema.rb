...
ActiveRecord::Schema.define(:version => 20120711032134) do
  ...
  create_table "act_load_lists", :force => true do |t|
    t.integer  "load_list_id",                                    :null => false
    t.date     "bill_date"
  ...
  add_index "carrying_bills", ["goods_cat_id"], :name => "index_carrying_bills_new_on_goods_cat_id"
  ...
  create_table "carrying_bills_old", :force => true do |t|
    t.date     "bill_date",                                                                                          :null => false
    t.string   "bill_no",                          :limit => 30,                                                     :null => false
    t.string   "goods_no",                         :limit => 30,                                                     :null => false
    t.integer  "from_customer_id"
  ...
  add_index "carrying_bills_old", ["area_id"], :name => "index_carrying_bills_on_area_id"
  add_index "carrying_bills_old", ["bill_date"], :name => "index_carrying_bills_on_bill_date"
  add_index "carrying_bills_old", ["bill_no"], :name => "index_carrying_bills_on_bill_no"
  add_index "carrying_bills_old", ["completed"], :name => "index_carrying_bills_on_completed"
  add_index "carrying_bills_old", ["deliver_info_id"], :name => "index_carrying_bills_on_deliver_info_id"
  add_index "carrying_bills_old", ["from_customer_id"], :name => "index_carrying_bills_on_from_customer_id"
  add_index "carrying_bills_old", ["from_customer_name"], :name => "index_carrying_bills_on_from_customer_name"
  add_index "carrying_bills_old", ["from_org_id"], :name => "index_carrying_bills_on_from_org_id"
  add_index "carrying_bills_old", ["from_short_fee_state"], :name => "index_carrying_bills_on_from_short_fee_state"
  add_index "carrying_bills_old", ["goods_no"], :name => "index_carrying_bills_on_goods_no"
  add_index "carrying_bills_old", ["load_list_id"], :name => "index_carrying_bills_on_load_list_id"
  add_index "carrying_bills_old", ["original_bill_id"], :name => "index_carrying_bills_on_original_bill_id"
  add_index "carrying_bills_old", ["pay_info_id"], :name => "index_carrying_bills_on_pay_info_id"
  add_index "carrying_bills_old", ["pay_type"], :name => "index_carrying_bills_on_pay_type"
  add_index "carrying_bills_old", ["payment_list_id"], :name => "index_carrying_bills_on_payment_list_id"
  add_index "carrying_bills_old", ["post_info_id"], :name => "index_carrying_bills_on_post_info_id"
  add_index "carrying_bills_old", ["print_counter"], :name => "index_carrying_bills_on_print_counter"
  add_index "carrying_bills_old", ["refound_id"], :name => "index_carrying_bills_on_refound_id"
  add_index "carrying_bills_old", ["settlement_id"], :name => "index_carrying_bills_on_settlement_id"
  add_index "carrying_bills_old", ["state"], :name => "index_carrying_bills_on_state"
  add_index "carrying_bills_old", ["to_customer_id"], :name => "index_carrying_bills_on_to_customer_id"
  add_index "carrying_bills_old", ["to_customer_name"], :name => "index_carrying_bills_on_to_customer_name"
  add_index "carrying_bills_old", ["to_org_id"], :name => "index_carrying_bills_on_to_org_id"
  add_index "carrying_bills_old", ["to_short_fee_state"], :name => "index_carrying_bills_on_to_short_fee_state"
  add_index "carrying_bills_old", ["transit_bill_no"], :name => "index_carrying_bills_on_transit_bill_no"
  add_index "carrying_bills_old", ["transit_deliver_info_id"], :name => "index_carrying_bills_on_transit_deliver_info_id"
  add_index "carrying_bills_old", ["transit_info_id"], :name => "index_carrying_bills_on_transit_info_id"
  add_index "carrying_bills_old", ["transit_org_id"], :name => "index_carrying_bills_on_transit_org_id"
  add_index "carrying_bills_old", ["type"], :name => "index_carrying_bills_on_type"
  add_index "carrying_bills_old", ["user_id"], :name => "index_carrying_bills_on_user_id"
