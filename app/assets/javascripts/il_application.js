...
jQuery(function($) {
	...
	$('form.computer_bill,form.auto_calculate_computer_bill').livequery(function() {
		...
		$('#auto_calculate_computer_bill_bill_no').attr('readonly', true);
		$('#auto_calculate_computer_bill_goods_no').attr('readonly', true);
	...
	$('#btn_generate_refound').bind('ajax:before', function() {
		...
		$('#refound_sum_transit_carrying_fee').html(sum_info.sum_transit_carrying_fee);
	...
	var re_cal_rest_fee = function() {
		var sum_info = $.bill_selector.sum_info;
